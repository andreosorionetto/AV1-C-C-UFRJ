...
O programa recebe um arquivo estruturado da seguinte forma: (table.txt foi o que nós criamos)
...
acordo com o algoritmo especificado (bubble ou merge), ordena o arquivo de acordo com o CAMPO DE ORDENACAO, e mostra na tela os CAMPOS DE PROJECAO ordenados.


No algoritmo merge sort nos utilizamos os conceitos de vetor da esquerda e vetor da direita apenas para facilitar na escrita do código.
